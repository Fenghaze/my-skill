...
description: "当用户希望回顾刚实现的功能、总结学习要点、分析设计思路或代码实现时触发。适用于'/knowledge-review'、'帮我总结这个功能'、'讲解一下这段代码'、'回顾一下'等请求。此技能会根据用户对相关知识点的掌握程度定制化总结内容。"
version: 1.0.2
author: fenghaze
---
...
| 掌握程度 | 总结策略 |
|---------|---------|
| 了解 | 概念详解 + 原理剖析 + 应用场景 + 代码示例 |
| 熟悉 | 核心原理 + 最佳实践 + 常见误区 + 进阶方向 |
| 掌握 | 深层原理 + 源码解析 + 变体对比 + 设计决策考量 |
| 精通 | 架构思维 + 权衡分析 + 扩展方向 + 如何向他人讲解 |
