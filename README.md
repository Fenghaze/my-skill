...
自动化skill同步仓库 - 最后更新时间: 2026-04-06 12:08:59
...
### enhance-chat-skill
**描述：** 增强型规划技能，使用设计树方法论进行严谨的软件设计。**凡涉及功能相关的请求（如新增功能、修改功能、删除功能、功能优化、bug修复、功能建议/咨询等），一律先调用此技能进行颗粒度对齐和需求收集**，确保后续实现的准确性。禁止在未经此技能进行需求分析前直接开始实现代码。
