...
try:
    ...
    print(f'\033[33m@{username}\033[0m \033[36m{cwd_display}\033[0m:[\033[33m{model_display}\033[0m|\033[35m{style_name}\033[0m|\033[32m{mode_label}\033[0m]\033[32m({context_info})\033[0m')
